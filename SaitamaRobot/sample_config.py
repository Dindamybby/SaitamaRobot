...
class Config(object):
    ...
    API_HASH = "awoo"
    TOKEN = "5122084606:AAFYfeAQFhfcDRn3QcG8dcp0Y4YjKWQNSvk"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = purwad1  # If you dont know, run the bot and do /id in your private chat with it, also an integer
